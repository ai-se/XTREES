...
\keywords{Defect prediction; Configuration; Planning; Decision trees.}
...
This paper  explores six Siegmund configuration data sets:  Berkeley DB (Java and C versions), Apache, SQLite, LLVM, and
  ...
  Regressor (from the SciKit learn kit~\cite{Pedregosa2012})   on one half, then applied to the other. After repeating this process 40 times, we achieved nearly perfect accuracy of $\{98.45\%, 99.62\%, 94.86\%, \%, 98.60\%, 99.87\%}\%$ respectively;
