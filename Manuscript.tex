...
\begin{figure}
\includegraphics[width=2in]{_figs/twod.eps} 
...
see our Validity section, later in this paper.
\ei
...
alternatives: 
 ...
 Method4 uses the decision tree learner of \fig{where}.D. 
  ...
  Note that all our methods are {\em trust-increasing} in the manner described in \tion{trust}.
