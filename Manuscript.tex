...
such that its performance ``improvess'', according to some measure. For  casew
stuides, we apply CROSSTREES to   (1)~reducethe predicted number
...
\section{From Clustering to  CROSSTREES}
...
\begin{figure}[!t]
\includegraphics[width=0.9\linewidth]{_figs/BDBC.eps}
\caption{Feature Model}\label{fig:bdbc}
\end{figure}
