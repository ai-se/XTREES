...
Although HOW manages to generate plans by localizing displacements to regions small enough to produce a statistically significant change, it needs to be noted that it fails to provide succinct summaries. In addition to this, plans derived from HOW 
...
\subsection{Design}
	\begin{figure}[t]
		...
		The data is recursively divided in clusters using WHERE. For more information, see \fig{where}a.
